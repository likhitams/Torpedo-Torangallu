 ...
 *
 * NOTE (PHP 8.2+): This class uses dynamic properties when copying controller properties
 * into the loader during view loading. The attribute below avoids deprecation warnings.
 */
    ...
    protected function _ci_init_class($class, $prefix = '', $config = FALSE, $object_name = NULL)
    {
        ...
        if ($config === NULL)
        {
            ...
            if (is_array($config_component->_config_paths))
            {
                ...
                {
                    // We test for both uppercase and lowercase; check environment first, global next

...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
					  {headerName: "Ladle No", field: "ladleno", width:450, cellClass: 'textAlign', filter: 'number'},
	                  {headerName: "Load Count", field: "load", width:250, cellClass: 'textAlignRight', filter: 'number'}

...
<script src="<?php echo asset_url(); ?>js/jquery.validate.min.js"></script>
    ...
    {
        headerName: "Time",
        field: "geofencename",  // Assuming this should be a different field for time
        width: 265,
        cellClass: 'textAlign',
        filter: 'number',
        suppressFilter: true
    ...
    {
        headerName: "threashold_interval",
        field: "threashold_interval",  // Assuming this should be a different field for time
        width: 265,
        cellClass: 'textAlign',
        filter: 'number',
        suppressFilter: true
    },
   {
    ...
    field: "threshold_interval",  // Corrected spelling
    width: 265,
    cellClass: 'textAlign',  // Ensure textAlign class doesn't interfere with radio button display
    filter: 'number',
    suppressFilter: true,
    cellRenderer: function(params) {
        if (params.data.threshold_interval == 1) {
            // Display radio button
            return '<input type="radio" name="entryexit" value="entry"> Entry';
        }
         else {
            // No radio button
            return '';
		...
		function setList() {
			...
			$.ajax({
				url: '<?php echo jquery_url() ?>maintenance/getgeofence10mtdata',
				dataType: 'json',

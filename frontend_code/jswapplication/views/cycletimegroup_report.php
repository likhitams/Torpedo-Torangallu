...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs =  [
					  {headerName: "Ladle Car No.", field: "CARNO",  suppressFilter:true, cellClass: 'textAlign', width:100},
					  {headerName: "Ladle No.", field: "LADLENO",  suppressFilter:true, cellClass: 'textAlign', width:100},
					  {headerName: "Cast. No", field: "TAPNO", suppressFilter:true, cellClass: 'textAlign', width:80},
	                  {headerName: "Source", field: "SOURCE",  suppressFilter:true, cellClass: 'textAlign', width:100},
	                  {headerName: "Runner HM Temp Deg.C", field: "TEMP", suppressFilter:true, cellClass: 'textAlignRight', width:150},	                  
	                  {headerName: "BDS Temp Deg.C", field: "BDSTEMP", suppressFilter:true, cellClass: 'textAlignRight',width:120},
	                  {headerName: "Destination", field: "DEST",  suppressFilter:true, cellClass: 'textAlign', width:110},
					  {headerName: "Empty Tare wt-1 Timing", field: "FIRST_TARE_TIME",  suppressFilter:true, cellClass: 'textAlign', width:180},
					  {headerName: "Gross wt Timing", field: "GROSS_DATE", suppressFilter:true, cellClass: 'textAlign', width:180},
	                  {headerName: "Iron Zone Time  (in min)", field: "ironzone",  suppressFilter:true, cellClass: 'textAlignRight', width:150},
	                  {headerName: "Gross wt Timing", field: "GROSS_DATE", suppressFilter:true, cellClass: 'textAlign', width:180},	                  
	                  {headerName: "Empty Tare wt-2 Timing", field: "TARE_DATE", suppressFilter:true, cellClass: 'textAlign',width:180},
	                  {headerName: "Steel Zone Time (in min)", field: "steelzone",  suppressFilter:true, cellClass: 'textAlignRight', width:150},
	                  {headerName: "Total Turn around Time (TAT) (in min)", field: "ironpsteel", suppressFilter:true, cellClass: 'textAlignRight', width:150},
	                  {headerName: "Remarks", field: "remarks", suppressFilter:true, cellClass: 'textAlignLeft', width:150}
	              ];

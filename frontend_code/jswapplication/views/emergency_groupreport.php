...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
						{headerName: "Torpedo Station No", field: "tracid",  suppressFilter:true, cellClass: 'textAlign', width:250},
						{headerName: "Empty Notification Generated", field: "signaltime",  suppressFilter:true, cellClass: 'textAlign', width:250},
						{headerName: "Torpedo moved out from SMS", field: "smstime",  suppressFilter:true, cellClass: 'textAlign', width:250},
	                   {headerName: "Difference (Mins)", field: "difference",  suppressFilter:true, cellClass: 'textAlign', width:200},

...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
						{headerName: "Ladle No", field: "ladleno",  suppressFilter:true, cellClass: 'textAlign', width:200},
					//	{headerName: "Ladle Car", field: "unitname",  suppressFilter:true, cellClass: 'textAlign', width:200},
	                  {headerName: "Report Time", field: "reporttime",  suppressFilter:true, cellClass: 'textAlign', width:200},
	                  {headerName: "Status", field: "status", suppressFilter:true, cellClass: 'textAlignLeft', width:170},
	                  {headerName: "Speed", field: "speed", suppressFilter:true, cellClass: 'textAlignRight', width:140,filter: 'number'},
	                  {headerName: "Location", field: "location", suppressFilter:true, cellClass: 'textAlignLeft',width:600}
	              ];

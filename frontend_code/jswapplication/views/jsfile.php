...
<script src="<?php echo base_url();?>assets/plugins/apx-charts/apexcharts.min.js"></script>
...
<!-- <script src="<?php echo base_url();?>assets/plugins/apx-charts/apexcharts.min.js"></script> -->
<script src="<?php echo base_url();?>assets/plugins/apx-charts/irregular-data-series.js"></script>
<script src="<?php echo base_url();?>assets/plugins/apx-charts/ohlc.js"></script>
<script src="<?php echo base_url();?>assets/pages/jquery.apexcharts.init1.js"></script>
      ...
      <script>
	   var httpResponse, map, activeInfoWindow;
            ...
            $(".hide-cir").click(function(){
				$("#dv_MAP").removeClass("col-lg-9");
				$("#dv_MAP").removeClass("map-v");
				
                $(".Circ").hide();
                $(".hide-cir").hide();
                $(".show-cir").show();
				
				$("#dv_MAP").attr("style","width:100% !important");
            ...
            $(".show-cir").click(function(){
               $("#dv_MAP").addClass("col-lg-9");
				$("#dv_MAP").addClass("map-v");
				
                $(".Circ").show();
                $(".hide-cir").show();
                $(".show-cir").hide();
				
				$("#dv_MAP").removeAttr("style");
...
<script type="text/javascript" src="<?php echo asset_url(); ?>js/staticConstants.js"></script>
 ...
 var polyArr = new Array(),
 	...
 	isBreachedArr = new Array(),
 	breachedDurArr = new Array(),
 	gfnameArr = new Array(),
	thresholdArr = new Array();
 	...
 	httpRequest.onreadystatechange = function() {
 		if (httpRequest.readyState == 4 && httpRequest.status == 200) {
 			...
 			httpResponse.forEach(function(data, index) {
 				...
 				isBreachedArr.push(data.is_breached);
				thresholdArr.push(data.threshold_time);
				breachedDurArr.push(data.breached_duration);
				gfnameArr.push(data.geofence);
 				cdreset();
 			});
 			...
 			latitudeArr.forEach(function(feature, index) {
 				...
 				switch (statusesArr[index]) {
 					...
 					case "202":
 						...
 						break;
 					case "203":
 						directionIcon = laddlecarIcons(dir, 'Blue');
 						break;
 					case "204":
 						directionIcon = laddlecarIcons(dir, 'Black');
 						break;
 					case "205":
 						directionIcon = laddlecarIcons(dir, 'Green');
 						break;
 ...
 function getText(status, index) {
	...
	if(thresholdArr[index] != 0 && breachedDurArr[index] != 0){
		thresholdInterval = "<li><strong>Threshold Interval:</strong> " + thresholdArr[index] + " </li>";
		thresholdInterval+= "<li><strong>Breached Duration:</strong> " + breachedDurArr[index] + " </li>";
		thresholdInterval+= "<li><strong>Geofence:</strong> " + gfnameArr[index] + " </li>";
	}
	
 	switch (status) {
 		case "201":
 			text = "<h3>" + httpResponse[index].ladleno + " (" + httpResponse[index].unitname + ") <span class='battery_icon'><img src='" + img + "'/></span></h3>" +
 				...
 				"<li><strong>Runner Temp:</strong> " + parseInt(httpResponse[index].TEMP) + " </li>" + idlet + thresholdInterval + "</ul>";
 			break;
 		case "202":
 			text = "<h3>" + httpResponse[index].ladleno + " (" + httpResponse[index].unitname + ") <span class='battery_icon'><img src='" + img + "'/></span></h3>" +
 				"<ul><li><strong>Cast No:</strong> " + httpResponse[index].TAPNO + " </li>" +
 				...
 				"<li><strong>Net Weight:</strong> " + httpResponse[index].NET_WEIGHT + " </li>" + idlet + thresholdInterval + "</ul>";
 			break;
 		case "203":
 			text = "<h3>" + httpResponse[index].ladleno + " (" + httpResponse[index].unitname + ") <span class='battery_icon'><img src='" + img + "'/></span></h3>" +
 		...
 		case "204":
 			text = "<h3>" + httpResponse[index].ladleno + " (" + httpResponse[index].unitname + ") <span class='battery_icon'><img src='" + img + "'/></span></h3>" +
 				...
 				"<li><strong>2nd Net Weight:</strong> " + httpResponse[index].NET_WT2 + " </li>" + idlet + thresholdInterval;
 ...
 function initMap() {
 	...
 	google.maps.event.addListenerOnce(map, 'idle', function() {
 		...
 		//timer = setTimeout("blinkBreached()", 1000);
		setInterval(blinkBreached,1000);
 ...
 function closeImageBtn() {
  ...
  function blinkBreached() {
 	httpResponse.forEach(function(feature, index) {
		
 		if (isBreachedArr[index] == 1) { 			
			gmarkers[index].setVisible(false);
			//setTimeout(function () {gmarkers[index].setMap(map);}, 200);
			console.log("breach-blinked"+index);

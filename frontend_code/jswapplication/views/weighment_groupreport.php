...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
					  {headerName: "Shift", field: "shift",  suppressFilter:true, cellClass: 'textAlign', width:80},
					  {headerName: "TLC No", field: "LADLENO",  suppressFilter:true, cellClass: 'textAlign', width:100},
					  {headerName: "First Tare Date", field: "FIRST_TARE_TIME",  suppressFilter:true, cellClass: 'textAlign', width:150},
					  {headerName: "Gross Date", field: "GROSS_DATE",  suppressFilter:true, cellClass: 'textAlign', width:150},
					  {headerName: "Tare Date", field: "TARE_DATE",  suppressFilter:true, cellClass: 'textAlign', width:150},
					  {headerName: "Supply Area", field: "dest",  suppressFilter:true, cellClass: 'textAlign', width:120},
	                  {headerName: "Gross wt", field: "GROSS_WEIGHT",  suppressFilter:true, cellClass: 'textAlign', width:100},
	                  {headerName: "Tare wt", field: "TARE_WEIGHT", suppressFilter:true, cellClass: 'textAlign', width:100},
	                  {headerName: "Net wt", field: "NET_WEIGHT", suppressFilter:true, cellClass: 'textAlign', width:100},
	                  {headerName: "Second Tare wt", field: "TARE_WT2", suppressFilter:true, cellClass: 'textAlign',width:100},
	                  {headerName: "Leftover HM", field: "hm", suppressFilter:true, cellClass: 'textAlign',width:120}

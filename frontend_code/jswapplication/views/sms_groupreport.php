...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
						{headerName: "Ladle No", field: "LADLENO",  suppressFilter:true, cellClass: 'textAlign', width:120},
					//	{headerName: "Ladle Car", field: "unitname",  suppressFilter:true, cellClass: 'textAlign', width:200},
						{headerName: "Temperature", field: "temp",  suppressFilter:true, cellClass: 'textAlign', width:120},
						{headerName: "Chemistry(C)", field: "ch",  suppressFilter:true, cellClass: 'textAlign', width:120},
	                  {headerName: "Chemistry Time", field: "HSM_DATE",  suppressFilter:true, cellClass: 'textAlign', width:200},
	                  {headerName: "Weighment Time", field: "GROSS_DATE", suppressFilter:true, cellClass: 'textAlign', width:200},
	                  {headerName: "SMS Exit Time", field: "SMS_TIME", suppressFilter:true, cellClass: 'textAlign', width:200},
	                  {headerName: "Empty Tare Time", field: "TARE_DATE", suppressFilter:true, cellClass: 'textAlign',width:200},
	                  {headerName: "Net Weight", field: "NET_WEIGHT", suppressFilter:true, cellClass: 'textAlign',width:175}

	...
	<div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="newModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<!--  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
					<h4 class="modal-title" id="newModalLabel">Breakdown Details</h4>
				</div>
				<div class="modal-body">
				...
				<div class="card-body">
					...
					<?php if ($detail[0]->userRole == 'c' || $detail[0]->userRole == 'a') { ?>
						<div class="fixed_footer">
							...
							<button type="button" class="btn btn-info" onclick="modifyBreakdown();setDatepicker();"><i class="fa-solid fa-pencil"></i> MODIFY</button>
							<button type="button" class="btn btn-dark" onclick="deleteBreakdown();"><i class="fa-solid fa-trash"></i> DELETE</button>
...
<script src="<?php echo asset_url(); ?>js/jquery.validate.min.js"></script>
	<script type="text/javascript">
		...
		function setList() {
			...
			$.ajax({
				url: '<?php echo jquery_url() ?>maintenance/getbreakdowndata',
				dataType: 'json',

...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
				//	  {headerName: "Car No.", field: "unitname",  suppressFilter:true, cellClass: 'textAlign', width:200},
					  {headerName: "Ladle No.", field: "lno",  suppressFilter:true, cellClass: 'textAlign', width:200},
					  {headerName: "Geo Fence area", field: "yard", suppressFilter:true, cellClass: 'textAlignLeft', width:200},
	                  {headerName: "From Time", field: "starttime",  suppressFilter:true, cellClass: 'textAlignRight', width:150},
	                  {headerName: "To Time", field: "endtime", suppressFilter:true, cellClass: 'textAlignRight', width:150},	                  
	                  {headerName: "Total Idle Time (Mins)", field: "idletime", suppressFilter:true, cellClass: 'textAlignRight',width:350}
	              ];

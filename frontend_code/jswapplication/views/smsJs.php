<?php
    ...
    var columnDefs = [			
	                  ...
	                  {headerName: "TLC No", field: "registration", width:100, cellClass: 'textAlignLeft', filter: 'text'},
	                  {headerName: "Temperature", field: "TEMP", width:80, cellClass: 'textAlign', filter: 'text'},
	                  {headerName: "Chemistry(C)", field: "C", width:105, cellClass: 'textAlign', filter: 'text'},
	                  {headerName: "Chemistry Time (dd:mm:yyyy)", field: "hm_update", width:160, cellClass: 'textAlign', filter: 'text',suppressFilter:true},
	                  {headerName: "Weighment Time (dd:mm:yyyy)", field: "GROSS_DATE", width:160, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
	                  {headerName: "SMS Exit Time (dd:mm:yyyy)", field:"smstime", width:160, cellClass: 'textAlign', filter: 'text',suppressFilter:true},
			          {headerName: "Empty Tare Time (dd:mm:yyyy)", field: "UNLOAD_DATE", width:160, cellClass: 'textAlign', filter: 'text', suppressFilter:true},
			          {headerName: "Net Weight", field: "NET_WEIGHT", width:90, cellClass: 'textAlign', filter: 'text', suppressFilter:true},
		              {headerName: "Status", field: "status", width:80, cellClass: 'textAlignLeft', filter: 'text',suppressFilter:true,cellStyle: function(params) {
	                  ...
	                  {headerName: "No Movement Since", field: "timehours", width:120, cellClass: 'textAlign', filter: 'text',suppressFilter:true,cellRenderer: function (params) {return secondsToString(params.value);},},
	                  {headerName: "Last Check (dd:mm:yyyy)", field: "lastreporttime", width:150, cellClass: 'textAlign', filter: 'text',suppressFilter:true}
	           		];

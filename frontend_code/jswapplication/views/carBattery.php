        ...
        <div class="container-fluid">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url(); ?>operations/saveBattery" method="post" onsubmit="return validateForm();">
                        <div class="full_body">
...
<?php echo $jsfileone; ?>
    ...
    <script type="text/javascript">
        ...
        var columnDefs = [{
            ...
            {
                headerName: "Battery Installed Date",
                field: "battery_installdate",
                width: 300,
                filter: 'text',
                cellClass: 'textAlign',
            ...
            {
                headerName: "Battery Since (in days)",
                field: "since",
                width: 150,
                cellClass: 'textAlignRight',
                filter: 'number',
            ...
            },
            {
                ...
                filter: 'number',
                suppressFilter: true,
                cellRenderer: checkBatteryStatus
            },

        ];

        function checkBatteryStatus(params) {
            if (params.data === undefined || params.data === null) {
                return false;
            } else {
                var reval = "";
                if (parseFloat(params.value) > 10 && params.data.batteryno != "0" && params.data.batteryno != "") {
                    reval = '<span class="battery_iconq"><img src="<?php echo asset_url(); ?>images/battery_f.png"/>' + params.data.fuel + '</span>';
                } else if (params.data.batteryno != "0" && params.data.batteryno != "") {
                    reval = '<span class="battery_iconq"><img src="<?php echo asset_url(); ?>images/battery_emp.gif"/>' + params.data.fuel + '</span>';
                }
        ...
        var gridOptions = {
            ...
            onRowValueChanged: function(event) {
                ...
                var id = data.id,
                    ...
                    oldbattery = data.oldbattery,
                    batteryno = data.batteryno;
                var battery_installdate = data.battery_installdate,
                    since = data.since,
                    fuel = data.fuel;

                // alert(id+"-----"+$.isNumeric(id));
                url = "<?php echo jquery_url(); ?>operations/updatebatteryDetails";
                //alert(types);
                $.post(url, {
                    id: id,
                    batteryno: batteryno,
                    battery_installdate: battery_installdate
                }, function(data1) {
                    //alert(data1);
        ...
        function exporttoExcel() {
            var title = "Battery Status Details";

...
<body onload="getData();" class="dark-sidenav">
    ...
    <div class="page-content">
        <div class="container-fluid">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="app-search-topbar float-left mr-2">
                                                    <input type="text"  id="search-box" class="srt from-control top-search mb-0" placeholder="Search here...">
           ...
           <?php  count($resLadle = $this->master_db->runQuerySql("SELECT lm.LOAD_STATUS, lm.id, REPLACE(CONCAT(lm.ladleno,' ->',u.location),'*','') as ladleno FROM ladle_master lm LEFT JOIN units u ON u.registration=lm.ladleno where 1 and lm.cycle=1 and lm.companyid = 95 and lm.phase='1' order by lm.id "));?>
          ...
          <?php count($resLadle = $this->master_db->runQuerySql("SELECT lm.LOAD_STATUS, lm.id, REPLACE(CONCAT(lm.ladleno,' ->',u.location),'*','') as ladleno FROM ladle_master lm LEFT JOIN units u ON u.registration=lm.ladleno where 1 and lm.cycle=1 and lm.companyid = 95 and lm.phase='2' order by lm.id "));?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                   <td>
                  <?php echo count($resLoco = $this->master_db->runQuerySql("select REPLACE(CONCAT(unitname,' ->',location),'*','') as unitname from units where unitname like 'LOCO%' and companyid = 95 order by unitname "));?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                <?php echo count($resmain = $this->master_db->runQuerySql("SELECT lm.LOAD_STATUS, lm.id, REPLACE(CONCAT(lm.ladleno,' ->',u.location),'*','') as unitname FROM ladle_master lm LEFT JOIN units u ON u.registration=lm.ladleno where 1 and lm.cycle=0 and lm.companyid =95 and lm.phase='1' order by lm.id"));?>
     ...
     <?php }?>
       ...
       <td>
                <?php echo count($resmain = $this->master_db->runQuerySql("SELECT lm.LOAD_STATUS, lm.id, REPLACE(CONCAT(lm.ladleno,' ->',u.location),'*','') as unitname FROM ladle_master lm LEFT JOIN units u ON u.registration=lm.ladleno where 1 and lm.cycle=0 and lm.companyid =95 and lm.phase='2' order by lm.id"));?>
                 <?php if(count($resmain)){?>
             <ul class="well">
              <?php foreach ($resmain as $r2){ ?>
           <li style="padding: 3px 9px !important;"><span class="maintenance"><span class="dot"></span><?php echo $r2->unitname;?></span></li>

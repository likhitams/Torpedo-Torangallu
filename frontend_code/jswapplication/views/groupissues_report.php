...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
        ...
        {headerName: "Loco No", field: "loconumber", width:265, cellClass: 'textAlignLeft', filter: 'text'},
        ...
        {headerName: "Delay Cause", field: "delaycause", width:265, cellClass: 'textAlign', filter: 'text'},

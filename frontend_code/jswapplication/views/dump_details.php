...
<body class="dark-sidenav">
 ...
 <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="newModalLabel">
      <div class="modal-dialog" role="document" >
        <div class="modal-content">
          <div class="modal-header">
          <!--  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> --> 
            <h4 class="modal-title" id="newModalLabel">Dumping Details</h4>
          </div>
          <div class="modal-body">
            ...
            <div class="form-group">
                    <label class="col-md-4">TLC No</label>
                    <span class="col-md-8">
                    <select class="form-control driverClass" required name="ladleno" id="ladleno">
                  ...
                  <div class="form-group">
                    <label class="col-md-4"> Schedule Date</label>
                    <span class="col-md-8">
                        <div class='input-group date date-picker1'>
                                <input type='text' class="form-control driverClass" name="scheduledate" id="scheduledate" />
                                <span class="input-group-addon" onclick="$('#date').focus();">
                  ...
                  <div class="form-group">
                    <label class="col-md-4"> Execution Date</label>
                    <span class="col-md-8">
                        <div class='input-group date date-picker1'>
                                <input type='text' class="form-control driverClass" name="executiondate" id="executiondate" />
                                <span class="input-group-addon" onclick="$('#date').focus();">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                 ...
                 <div class="form-group">
                    <label class="col-md-4">1st Tare Weight</label>
                    <span class="col-md-8">
                    <input type="text" class="form-control driverClass" name="tarewt" id="tarewt">
                    </span>
                  </div>
                  
                   <div class="form-group">
                    <label class="col-md-4">After Dump Tare Weight</label>
                    <span class="col-md-8">
                    <input type="text" class="form-control driverClass" name="dumptarewt" id="dumptarewt">
                    </span>
                  </div>
                
                 <div class="form-group">
                    <label class="col-md-4">Net Weight</label>
                    <span class="col-md-8">
                    <input type="text" class="form-control driverClass" name="netwt" id="netwt">
                    </span>
                  </div>
                  
                  <div class="form-group">
                    <label class="col-md-4">Flakes</label>
                    <span class="col-md-8">
                    <input type="text" class="form-control driverClass" name="flakes" id="flakes">
                    </span>
                  </div>
                  
                   <div class="form-group">
                    <label class="col-md-4">Metal</label>
                    <span class="col-md-8">
                    <input type="text" class="form-control driverClass" name="metal" id="metal">
                    </span>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <span class="col-md-8">
                    <input type="text" class="form-control driverClass" name="remarks" id="remarks">
                    </span>
                  </div>
            </form>
 ...
 <button data-toggle="modal" data-target="#newModal" style="display: none;" id="editbox"></button>
      ...
      <div class="search_header">
       ...
       <div class="full_body"> 
        ...
        <div class="fixed_footer">
          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#newModal" onclick="$('.newButton').show();setDatepicker();$('.updateButton').hide();">NEW</button>
          <button type="button" class="btn btn-primary" onclick="modifyDump();setDatepicker();">MODIFY</button>
          <button type="button" class="btn btn-danger" onclick="deleteDump();">DELETE</button>
          <button  class="btn btn-success btn-min" type="button" title="Download to Excel" onclick="convertdata();"><i class="fa fa-file-excel-o">Download Excel</i></button>
  ...
  $(document).ready(function(){  
   ...
   $("#saveButton").click(function(evt){
    if(v.form()){
      ...
      if(vald){
        ...
        //alert(str);
        $.post("<?php echo jquery_url();?>maintenance/addDump",str,function(data){
          //alert(data);
          if(parseInt(data) == 1){
   ...
   function validateForm(){
     ...
     var dumptarewt = $("#dumptarewt").val();
     var netwt = $("#netwt").val();
     var flakes = $("#flakes").val();
     var metal = $("#metal").val();
     var remarks = $("#remarks").val();

     if(scheduledate == "" ){
        $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Schedule Date</div>');
        return false;
      }
     else if(executiondate == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Execution Date</div>');
        return false;
     }
     else if(tarewt == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Tare Weight</div>');
        return false;
     }
    else if(dumptarewt == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Dump Tare Weight</div>');
        return false;
     }
    else if(netwt == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Net Weight</div>');
        return false;
     }
    else if(tarewt == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter 1st Tare Weight</div>');
        return false;
     }
     else if(flakes == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Flakes</div>');
        return false;
     }
     else if(metal == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Metal</div>');
        return false;
     }
     else if(remarks == ""){
       $("#msg_box").html('<div class="alert alert-danger alert-dismissable"><button class="close" aria-hidden="true" data-dismiss="alert" type="button">&times;</button>Please Enter Remarks</div>');
        return false;
     }
     else{
      return true;
   ...
   $("#esaveButton").click(function(evt){
      if(v.form()){
        ...
        if(vald){
          ...
          $.post("<?php echo jquery_url();?>maintenance/modifyDump",str,function(data){
            //alert(data);
            switch(data){
  ...
  var arra = new Array();
    var columnDefs = [      
            {headerName: "id", field: "id", width: 0,hide:true},      
                    {headerName: "TLC No", field: "ladleno", width:150, cellClass: 'textAlignLeft', filter: 'text',checkboxSelection: true},
                    {headerName: " Schedule Date", field: "scheduledate", width:150, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
                    {headerName: " Execution Date", field: "executiondate", width:150, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
                    {headerName: "1st Tare Weight", field: "tarewt", width:150, cellClass: 'textAlign', filter: 'text', suppressFilter:true, suppressSorting:true},
                    {headerName: "After Dump Tare Weight", field: "dumptarewt", width:150, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
                    {headerName: " Net Weight", field: "netwt", width:150, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
                    {headerName: "Flakes", field: "flakes", width:150, cellClass: 'textAlign', filter: 'text',suppressFilter:true},
                    {headerName: "Metal", field: "metal", width:150, cellClass: 'textAlign', filter: 'text',suppressFilter:true},
                    {headerName: "Remarks", field: "remarks", width:150, cellClass: 'textAlign', filter: 'text',suppressFilter:true}
 ...
 // setup the grid after the page has finished loading
  ...
  function setList(){
    ...
    $.ajax({
           url:  '<?php echo jquery_url()?>maintenance/getDumpDetails',
           dataType: 'json',
    ...
    if(selectedRows.length == 0){
      $("#error-msg").html("Please select TLC Number to modify");
      $("#alertbox").click();
      return;
    }
    /*else if(selectedRows[0].cycleCompleted == "1"){
      ...
      $("#oid").val(selectedRows[0].id);
        ...
        $("#scheduledate").val(selectedRows[0].scheduledate);
        $("#executiondate").val(selectedRows[0].executiondate);
        $("#tarewt").val(selectedRows[0].tarewt);
        $("#dumptarewt").val(selectedRows[0].dumptarewt);
        $("#netwt").val(selectedRows[0].netwt);
        $("#flakes").val(selectedRows[0].flakes);
        $("#metal").val(selectedRows[0].metal);
        $("#remarks").val(selectedRows[0].remarks);
        //getSubmenu();
    ...
    if(selectedRows.length){
      ...
      if(r == true){
        ...
        $.post("<?php echo base_url();?>maintenance/deleteDump",{unitIds:unitIds},function(data){
          //alert(data);
...
//Excel Import
  ...
  function createWorksheet(){
            //  Calculate cell data types and extra class names which affect formatting
                      var cellType = [], title = "Ladle Dump Details";
                      var cellTypeClass = [];

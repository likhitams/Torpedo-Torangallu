...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
					  {headerName: "Ladle No", field: "LADLENO",  suppressFilter:true, cellClass: 'textAlign', width:90},
					  {headerName: "Cast No", field: "castnumber",  suppressFilter:true, cellClass: 'textAlign', width:90},
					  {headerName: "Tap Hole", field: "tapno", suppressFilter:true, cellClass: 'textAlign', width:70},
					  {headerName: "Temperature", field: "temp",  suppressFilter:true, cellClass: 'textAlign', width:100},
					  {headerName: "Chemistry(C)", field: "ch", suppressFilter:true, cellClass: 'textAlign', width:60},
	                  {headerName: "BF Entry", field: "castentry",  suppressFilter:true, cellClass: 'textAlign', width:130},
	                  {headerName: "BF Exit", field: "castexit", suppressFilter:true, cellClass: 'textAlign', width:130},	                  
	                  {headerName: "Gross Date", field: "webmentdate", suppressFilter:true, cellClass: 'textAlign',width:130},
	                  {headerName: "Net Weight", field: "netweight", suppressFilter:true, cellClass: 'textAlign', width:130},
	                  {headerName: "SMS Entry", field: "smsentry", suppressFilter:true, cellClass: 'textAlign', width:130},
	                  {headerName: "SMS Exit", field: "smstime", suppressFilter:true, cellClass: 'textAlign', width:130},
	                  {headerName: "Empty Tare", field: "taredate", suppressFilter:true, cellClass: 'textAlign', width:130},
	                  {headerName: "TAT (in Min)", field: "totalturn", suppressFilter:true, cellClass: 'textAlign', width:120}
	              ];

...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
					  {headerName: "Date", field: "conditionDate", width:120, cellClass: 'textAlignLeft', filter: 'text'},
				<?php foreach ($remarks as $r){?>
	                  {headerName: "<?php echo $r->remarks;?>", field: "w<?php echo $r->id;?>", width:140, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
	                  <?php }?>

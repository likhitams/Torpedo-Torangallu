...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
						{headerName: "Ladle No", field: "ladleno",  suppressFilter:true, cellClass: 'textAlign', width:337},
	                  {headerName: "Report Time", field: "reporttime",  suppressFilter:true, cellClass: 'textAlign', width:337},
	                  {headerName: "Load Status", field: "loadstatus", suppressFilter:true, cellClass: 'textAlign', width:337},
	                  {headerName: "Location", field: "location", suppressFilter:true, cellClass: 'textAlignLeft',width:337}
	              ];

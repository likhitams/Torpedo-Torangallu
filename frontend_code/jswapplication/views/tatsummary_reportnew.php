   ...
   <body class="dark-sidenav">
	  ...
	  $(document).ready(function() {
		...
		var columnDefs = [
			...
			{
				headerName: "Trip Start",
				field: "trip_start",
				width: 115,
				cellStyle: {justifyContent: "left"},
			},
			{
				headerName: "Partial Load",
				field: "partial_load",
				width: 115,
				cellStyle: {justifyContent: "left"},
			},
			...
			{
				headerName: "Is Refill?",
				field: "is_refill",
				width: 60,
				cellStyle: {justifyContent: "left"},
			},
			{
				headerName: "Iron Zone (Hrs)",
				field: "iron_zone",
				width: 100,
				cellStyle: {justifyContent: "left"},
			},
			{
				headerName: "Steel Zone (Hrs)",
				field: "steel_zone",
				width: 100,
				cellStyle: {justifyContent: "left"},
			},
		...
		function setList() {
			...
			$.ajax({
				type: "POST",
				//async: false,
				url: '<?php echo jquery_url();?>tatsummary/getSummaryReport',

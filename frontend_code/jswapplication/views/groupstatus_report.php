...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
        ...
        {headerName: "Ladle No", field: "ladleno", width:180, cellClass: 'textAlignLeft', filter: 'text'},
        {headerName: "Torpedo Ladle Capacity(in tons)", field: "capacity", width:220, cellClass: 'textAlign', filter: 'number', suppressFilter:true},
        {headerName: "Supplier", field: "supplier", width:180, cellClass: 'textAlign', filter: 'text', suppressFilter:true, suppressSorting:true},
        {headerName: "Guarantee Life", field: "guarantee", width:180, cellClass: 'textAlign', filter: 'text'},
        {headerName: "Life(No.of Heats)", field: "beats", width:180, cellClass: 'textAlign', filter: 'text'},
        {headerName: "Status", field: "status", width:180, cellClass: 'textAlign', filter: 'text'},
        {headerName: "Down Date", field: "downdate", width:180, cellClass: 'textAlign', filter: 'text'}

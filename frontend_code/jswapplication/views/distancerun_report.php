...
<link href="<?php echo asset_url();?>css/font-awesome.css" rel="stylesheet">
  ...
  <body>
    ...
    var columnDefs = [
						{headerName: "Ladle No", field: "ladleno",  suppressFilter:true, cellClass: 'textAlign', width:250},
						{headerName: "Distance (KMS)", field: "distance",  suppressFilter:true, cellClass: 'textAlign', width:250},
						{headerName: "Moving Hours", field: "mhrs",  suppressFilter:true, cellClass: 'textAlign', width:250},
		                {headerName: "Report Time", field: "reportdate",  suppressFilter:true, cellClass: 'textAlign', width:250},

  ...
  <script>
    ...
    function laddlecarIcons(ladleid, Color) {
      ...
      if (ladleid == 1) {
        ...
        directionIcon = baseUrl + "Ladle/" + Loco + '/1.png';
         alert(directionIcon);
         
      } else if (ladleid == 137) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/2.png';
      } else if (ladleid == 138) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/3.png';
      } else if (ladleid == 139) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/4.png';
      } else if (ladleid == 140) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/5.png';
      } else if (ladleid == 141) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/6.png';
      } else if (ladleid == 142) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/7.png';
      } else if (ladleid == 143) {
        directionIcon = baseUrl + "Ladle/" + Loco + '/8.png';
      }
